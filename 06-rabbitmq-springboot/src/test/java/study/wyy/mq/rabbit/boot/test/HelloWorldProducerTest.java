...
import study.wyy.mq.rabbit.boot.consumer.HelloWorldConsumer;
...
public class HelloWorldProducerTest {
    ...
    /****
     * hello world模式：是不需要交换机的哟
     */
    @Test
    public void testSendMessage(){
        // 参数一：routeKey: hello world模式是直接发到队列中，所以这里就是队列的名字
        // 参数二：消息体，rabbitTemplate已经给封装成一个对象，可以直接传一个对象过去
        rabbitTemplate.convertAndSend("hello-queue","一条hello world模式的消息");
    }
}
